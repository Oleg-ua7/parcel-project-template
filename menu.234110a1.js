...
(function () {
  var menuBinRef = document.querySelector('[data-menu-button]');
  var mobileMenuRef = document.querySelector('[data-menu]');
  menuBinRef.addEventListener('click', function () {
    var expanded = menuBinRef.getAttribute('aria-expanded') === 'true' || false;
